<div class="kt-container-fixed space-y-5">
    <div>
        <h2 class="text-3xl font-semibold mb-8 text-gray-800 border-b-2 pb-2 w-80">LPM Channel</h2>
        <div class="space-y-5">
    ...
    <div>
        <h2 class="text-3xl font-semibold mb-8 text-gray-800 border-b-2 pb-2 w-80">Podcast NOL SKS</h2>
        <div class="space-y-5">
