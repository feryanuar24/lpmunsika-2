            ...
            <div class="kt-modal-content max-w-md w-[90%] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6">
                ...
                <div class="kt-modal-footer">
                    ...
                    <div class="flex gap-4">
                        <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal" type="button">Tidak,
                            Kembali</button>
            ...
            <div class="kt-modal-content max-w-md w-[90%] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6">
                <form action="{{ route('menus') }}" method="GET">
                    ...
                    <div class="kt-modal-footer">
                        <div></div>
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal_topbar_search"
        ...
        <div class="kt-modal" data-kt-modal="true" id="modal_topbar_notifications">
            <div class="kt-modal-content max-w-md w-[90%] fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-6">
                ...
                <div class="kt-modal-footer">
                    <div></div>
                    <div class="flex gap-4">
                        <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal_topbar_notifications"
                            type="button">Kembali</button>
                    </div>
                </div>
            </div>
