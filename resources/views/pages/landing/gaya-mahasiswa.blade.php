    ...
    <div class="kt-container-fixed py-8">
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-semibold text-mono mb-2 border-b-4 border-primary-600 inline-block pb-2">
                ...
                Semua Gaya Mahasiswa
            </h1>
            <p class="text-mono mt-4">Eksplorasi inspirasi, cerita, dan gaya hidup mahasiswa di sini.</p>
        </div>

        <!-- Articles Grid -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            @forelse ($data['articles'] as $article)
                <article class="kt-card hover:shadow-lg transition-shadow duration-300 overflow-hidden">
