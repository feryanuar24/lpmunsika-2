...
@section('content')
    <div class="w-full">
        ...
        <form action="{{ route('verification.send') }}" method="POST" class="space-y-5">
            ...
            <button type="button" class="kt-btn kt-btn-primary" data-kt-modal-toggle="#modal-verify-email">Kirim ulang email
                verifikasi</button>

            <div class="kt-modal z-40" data-kt-modal="true" id="modal-verify-email">
                <div
                    ...
                    <div class="kt-modal-header">
                        ...
                        <button type="button" class="kt-modal-close" aria-label="Close modal"
                            data-kt-modal-dismiss="#modal-verify-email">
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-verify-email" type="button">Tidak, Kembali</button>
