...
@section('content')
    ...
    <!-- Container -->
    <div class="kt-container-fixed">
        <form action="{{ route('users.store') }}" method="POST" class="kt-card p-5 space-y-5">
            @csrf
            ...
            <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-create-user">Tambah
                Pengguna</button>
                ...
                <div
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-create-user" type="button">Tidak, Kembali</button>
