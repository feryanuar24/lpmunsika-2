                                        ...
                                        <td>
                                            <div class="flex justify-start gap-2">
                                                ...
                                                <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="button" data-kt-modal-toggle="#modal-delete-user-{{ $user->id }}"
                                                        class="kt-btn kt-btn-icon kt-btn-outline size-6">
                                                        <i class="ki-filled ki-trash"></i>
                                                    </button>
                                                    <div class="kt-modal z-40" data-kt-modal="true" id="modal-delete-user-{{ $user->id }}">
                                                        <div
                                                            ...
                                                            <div class="kt-modal-header">
                                                                ...
                                                                <button type="button" class="kt-modal-close"
                                                                    aria-label="Close modal" data-kt-modal-dismiss="#modal-delete-user-{{ $user->id }}">
                                                            ...
                                                            <div class="kt-modal-footer">
                                                                ...
                                                                <div class="flex gap-4">
                                                                    <button class="kt-btn kt-btn-secondary"
                                                                        data-kt-modal-dismiss="#modal-delete-user-{{ $user->id }}" type="button">Tidak,
                                                                        Kembali</button>
