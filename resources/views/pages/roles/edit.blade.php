...
@section('content')
    ...
    <!-- Container -->
    <div class="kt-container-fixed">
        <form action="{{ route('roles.update', $data['role']->id) }}" method="POST" class="kt-card p-5 space-y-5">
            @method('PATCH')
            ...
            <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-edit-role">Edit
                Role</button>
                ...
                <div
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-edit-role" type="button">Tidak, Kembali</button>
