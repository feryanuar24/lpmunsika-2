...
@section('content')
    ...
    <!-- Container -->
    <div class="kt-container-fixed">
        <form action="{{ route('footers.store') }}" method="POST" class="kt-card p-5 space-y-5">
            @csrf
            ...
            <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-create-footer">Tambah
                Footer</button>

            <div class="kt-modal z-40" data-kt-modal="true" id="modal-create-footer">
                <div
                    ...
                    <div class="kt-modal-header">
                        ...
                        <button type="button" class="kt-modal-close" aria-label="Close modal"
                            data-kt-modal-dismiss="#modal-create-footer">
                    ...
                    <div class="kt-modal-body">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-medium">Anda menambah footer dengan data ini.</p>
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-create-footer" type="button">Tidak, Kembali</button>
