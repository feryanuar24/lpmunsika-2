...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('embeds.update', $data['embed']->id) }}" method="POST" class="kt-card p-5 space-y-5">
            ...
            <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-edit-embed">Edit
                Penyematan</button>
                ...
                <div
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-edit-embed" type="button">Tidak, Kembali</button>
