...
@section('content')
    ...
    <form action="{{ route('password.update') }}" class="space-y-5" method="POST">
        ...
        <button type="button" class="kt-btn kt-btn-primary" data-kt-modal-toggle="#modal-new-password">Perbarui Kata Sandi</button>

        <div class="kt-modal z-40" data-kt-modal="true" id="modal-new-password">
            <div
                ...
                <div class="kt-modal-header">
                    ...
                    <button type="button" class="kt-modal-close" aria-label="Close modal" data-kt-modal-dismiss="#modal-new-password">
                ...
                <div class="kt-modal-footer">
                    ...
                    <div class="flex gap-4">
                        <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-new-password" type="button">Batal</button>
