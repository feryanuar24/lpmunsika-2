...
@section('content')
    ...
    <form action="{{ route('password.email') }}" class="space-y-5" method="POST">
        ...
        <button type="button" data-kt-modal-toggle="#modal-forgot-password" class="kt-btn kt-btn-primary">Kirim Permintaan</button>

        <div class="kt-modal z-40" data-kt-modal="true" id="modal-forgot-password">
            <div
                ...
                <div class="kt-modal-header">
                    ...
                    <button type="button" class="kt-modal-close" aria-label="Close modal" data-kt-modal-dismiss="#modal-forgot-password">
                ...
                <div class="kt-modal-footer">
                    ...
                    <div class="flex gap-4">
                        <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-forgot-password" type="button">Tidak, Kembali</button>
