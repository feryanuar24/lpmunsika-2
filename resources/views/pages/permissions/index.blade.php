    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5 lg:items-end">
            ...
            <div class="flex items-center gap-2.5">
                <a class="kt-btn kt-btn-primary" href="{{ route('permissions.create') }}">
                    Tambah
                </a>
            </div>
        </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="w-20" data-kt-datatable-column="email">
                                        <span class="kt-table-col"><span class="kt-table-col-label">Nama
                                                Tampilan</span><span class="kt-table-col-sort"></span></span>
                                    </th>
                                        ...
                                        <td>
                                            <div class="flex justify-start gap-2">
                                                ...
                                                <form action="{{ route('permissions.destroy', $permission->id) }}"
                                                    ...
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="button" data-kt-modal-toggle="#modal-delete-permission-{{ $permission->id }}"
                                                        class="kt-btn kt-btn-icon kt-btn-outline size-6">
                                                        <i class="ki-filled ki-trash"></i>
                                                    </button>
                                                    <div class="kt-modal z-40" data-kt-modal="true" id="modal-delete-permission-{{ $permission->id }}">
                                                        <div
                                                            ...
                                                            <div class="kt-modal-header">
                                                                ...
                                                                <button type="button" class="kt-modal-close"
                                                                    aria-label="Close modal" data-kt-modal-dismiss="#modal-delete-permission-{{ $permission->id }}">
                                                            ...
                                                            <div class="kt-modal-body">
                                                                <div class="flex items-center gap-4">
                                                                    ...
                                                                    <div>
                                                                        <p class="font-medium">Anda menghapus permission
                                                                            ini.
                                                                        </p>
                                                            ...
                                                            <div class="kt-modal-footer">
                                                                ...
                                                                <div class="flex gap-4">
                                                                    <button class="kt-btn kt-btn-secondary"
                                                                        data-kt-modal-dismiss="#modal-delete-permission-{{ $permission->id }}" type="button">Tidak,
                                                                        Kembali</button>
