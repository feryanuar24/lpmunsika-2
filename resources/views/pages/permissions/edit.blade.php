...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('permissions.update', $data['permission']->id) }}" method="POST"
            ...
            <button type="button" class="kt-btn kt-btn-primary mt-5" data-kt-modal-toggle="#modal-edit-permission">Edit
                Permission</button>
                ...
                <div
                    ...
                    <div class="kt-modal-footer">
                        ...
                        <div class="flex gap-4">
                            <button class="kt-btn kt-btn-secondary" data-kt-modal-dismiss="#modal-edit-permission" type="button">Tidak, Kembali</button>
